...
import com.alexafit.fitjournal.core.presentation.theme.DarkGray
...
fun AddWorkoutErrorScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.error_add_workout_title),
            ...
            Text(
                text = stringResource(id = R.string.text_back_to_add_workout_list),
                style = MaterialTheme.typography.headlineMedium,
