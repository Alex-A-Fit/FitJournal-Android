...
import com.alexafit.fitjournal.core.presentation.commoncomponents.dialogs.components.editworkoutset.EditWorkoutSetProperties
...
fun EditWorkoutSetDialog(
    ...
    Dialog(
        ...
        Column(
            ...
            TitleAndCancelButton(onDismissRequest = onDismissRequest)
...
@Composable
private fun TitleAndCancelButton(
    onDismissRequest: () -> Unit
) {
    Row(
        modifier = Modifier
